...
#define WLAN_CONNECT_WPA_SSID                "Xperia Z5 Compact_f497"         /**< Macros to define WPA/WPA2 network settings */
#define WLAN_CONNECT_WPA_PASS                "yoni2511"      /**< Macros to define WPA/WPA2 network settings */
#define BUFFER_SIZE        UINT8_C(4)
/** IP addressed of server side socket.Should be in long format, E.g: 0xc0a82177 == 192.168.33.119 */
#define SERVER_IP         UINT32_C(0xC0A82B1E)
#define SERVER_PORT        UINT16_C(1234)           /**< Port number on which server will listen */
